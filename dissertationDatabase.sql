...
ALTER TABLE APP_USER ADD COLUMN ACTIVE BOOLEAN DEFAULT TRUE;
ALTER TABLE APP_USER ADD CONSTRAINT NEW_UNIQUE UNIQUE (NICKNAME);
ALTER TABLE APP_USER ALTER COLUMN NICKNAME NOT NULL;